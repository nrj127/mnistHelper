...
clf = DecisionTreeClassifier(criterion='gini',max_depth=12, max_features=370)
...
#clf1 = DecisionTreeClassifier(criterion='entropy',max_depth=12, max_features=350).fit(X_train,y_train)
#scores = clf1.score(X_test,y_test)

clf1 = DecisionTreeClassifier(criterion='gini',max_depth=12, max_features=370)
scores = cross_validation.cross_val_score(clf1,images,labels,cv=10)
